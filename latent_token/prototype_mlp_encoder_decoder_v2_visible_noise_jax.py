...
def main():
    ...
    ap.add_argument("--out_csv", default="outputs/visible_token_v2_reconstruct.csv")
    ap.add_argument("--stats_out", default="outputs/visible_token_v2_norm_stats.npz")
    args = ap.parse_args()
    ...
    all_rows = []
    all_rows.extend(train_model("visible_token_v2", visible_model, arrays, train_idx, test_idx, args))
    all_rows.extend(train_model("flat_latent_baseline", flat_model, arrays, train_idx, test_idx, args))
    ...
    print("\n=== v2 visible-token reconstruct under latent noise ===")
    for r in all_rows:
        print(
